...
function update_config {
	...
	[ -z "$changes" ] && changes="No config changes"
...
find $build_dir -mindepth 1 ! -name $k_commit ! -name $f_commit ! -name $u_commit -exec rm -rf {} \; # Delete all files except tarballs of latest git commits
